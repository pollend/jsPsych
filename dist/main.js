...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _init = __webpack_require__(329);

	var _init2 = _interopRequireDefault(_init);

	var _pluginAPI = __webpack_require__(330);
	...
	var _turk = __webpack_require__(334);
	...
	(0, _init2.default)(JsPsych);
	(0, _turk.initTurk)(jsPsych);
	JsPsych.prototype.pluginAPI = new _pluginAPI2.default();
	JsPsych.prototype.data = new _data2.default();

	exports.default = JsPsych;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _JsPsych = __webpack_require__(327);
	...
	// target DOM element
	var DOM_container = void 0;
	var DOM_target = void 0;
	// time that the experiment began
	var exp_start_time = void 0;
	...
	function finishExperiment() {
	    ...
	    opts.on_finish(_JsPsych2.default.data.get());
	}
	...
	function doTrial(trial) {
	    ...
	    _JsPsych2.default.plugins[trial.type].trial(DOM_target, trial);
	...
	function evaluateFunctionParameters(trial) {
	    ...
	    for (var i = 0; i < keys.length; i++) {
	        if (keys[i] !== 'type') {
	            if (typeof _JsPsych2.default.plugins.universalPluginParameters[keys[i]] !== 'undefined' && _JsPsych2.default.plugins.universalPluginParameters[keys[i]].type !== _JsPsych2.default.plugins.parameterType.FUNCTION || typeof _JsPsych2.default.plugins[trial.type].info.parameters[keys[i]] !== 'undefined' && _JsPsych2.default.plugins[trial.type].info.parameters[keys[i]].type !== _JsPsych2.default.plugins.parameterType.FUNCTION) {
	...
	function setDefaultValues(trial) {
	    var trial_parameters = Object.keys(_JsPsych2.default.plugins[trial.type].info.parameters);
	    for (var i = 0; i < trial_parameters.length; i++) {
	        if (typeof trial[trial_parameters[i]] === 'undefined' || trial[trial_parameters[i]] === null) {
	            if (typeof _JsPsych2.default.plugins[trial.type].info.parameters[trial_parameters[i]].default === 'undefined') {
	                console.error('You must specify a value for the ' + trial_parameters[i] + ' parameter in the ' + trial.type + ' plugin.');
	            } else {
	                trial[trial_parameters[i]] = _JsPsych2.default.plugins[trial.type].info.parameters[trial_parameters[i]].default;
	            }
	        }
	    }
	}
	...
	function checkExclusions(exclusions, success, fail) {
	    ...
	    if (typeof exclusions.min_width !== 'undefined' || typeof exclusions.min_height !== 'undefined') {
	        ...
	        if (w < mw || h < mh) {
	            ...
	            var interval = setInterval(function () {
	                ...
	                var h = window.innerHeight;
	                if (w < mw || h < mh) {
	                    core.getDisplayElement().innerHTML = '<p>Your browser window is too small to complete this experiment. ' + 'Please maximize the size of your browser window. If your browser window is already maximized, ' + 'you will not be able to complete this experiment.</p>' + '<p>The minimum width is ' + mw + 'px. Your current width is ' + w + 'px.</p>' + '<p>The minimum height is ' + mh + 'px. Your current height is ' + h + 'px.</p>';
	                } else {
	    ...
	    if (typeof exclusions.audio !== 'undefined' && exclusions.audio) {
	        if (window.hasOwnProperty('AudioContext') || window.hasOwnProperty('webkitAudioContext')) {
	            ...
	            clear = false;
	            core.getDisplayElement().innerHTML = '<p>Your browser does not support the WebAudio API, which means that you will not ' + 'be able to complete the experiment.</p><p>Browsers that support the WebAudio API include ' + 'Chrome, Firefox, Safari, and Edge.</p>';
	            fail();
	            return;
	        }
	    }
	...
	function initMixin(jsPsych) {
	    ...
	    jsPsych.prototype.init = function (options) {
	        ...
	        _JsPsych2.default.pluginAPI.initAudio();

	        // below code resets event listeners that may have lingered from
	        // a previous incomplete experiment loaded in same DOM.
	        _JsPsych2.default.pluginAPI.reset(opts.display_element);
	        // create keyboard event listeners
	        _JsPsych2.default.pluginAPI.createKeyboardEventListeners(opts.display_element);
	        // create listeners for user browser interaction
	        _JsPsych2.default.data.createInteractionListeners();
	        ...
	        checkExclusions(opts.exclusions, function () {
	            ...
	            if (opts.auto_preload) {
	                _JsPsych2.default.pluginAPI.autoPreload(timeline, startExperiment, opts.preload_images, opts.preload_audio, opts.show_preload_progress_bar);
	    ...
	    jsPsych.prototype.finishTrial = function (data) {
	        ...
	        _JsPsych2.default.data.write(data);

	        // get back the data with all of the defaults in
	        var trial_data = _JsPsych2.default.data.get().filter({ trial_index: global_trial_index });
	    ...
	    jsPsych.prototype.endExperiment = function (end_message) {
	        ...
	        timeline.end();
	        _JsPsych2.default.pluginAPI.cancelAllKeyboardResponses();
	        _JsPsych2.default.pluginAPI.clearAllTimeouts();
	        core.finishTrial();
	    };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _utility = __webpack_require__(331);
	...
	var PluginAPI = function () {
	    ...
	    _createClass(PluginAPI, [{
	        key: 'root_keydown_listener',
	        value: function root_keydown_listener(e) {
	        ...
	        key: 'root_keyup_listener',
	        value: function root_keyup_listener(e) {
	            this.held_keys[e.keyCode] = false;
	        }
	    }, {
	        key: 'reset',
	        value: function reset(root_element) {
	            this.keyboard_listeners = [];
	            this.held_keys = {};
	        ...
	        key: 'createKeyboardEventListeners',
	        value: function createKeyboardEventListeners(root_element) {
	        ...
	        value: function getKeyboardResponse(parameters) {
	        ...
	        value: function initAudio() {
	            this.context = _JsPsych2.default.initSettings().use_webaudio === true ? _JsPsych2.default.webaudio_context : null;
	        }
	    }, {
	        key: 'audioContext',
	        ...
	        value: function preloadAudioFiles(files, callback_complete, callback_load) {

	            files = (0, _utility.flatten)(files);
	            files = (0, _utility.unique)(files);
	            ...
	            function load_audio_file_webaudio(source, count) {
	                ...
	                request.onerror = function () {
	                    if (count < _JsPsych2.default.initSettings().max_preload_attempts) {
	                        setTimeout(function () {
	                            load_audio_file_webaudio(source, count + 1);
	                        }, 200);
	                    } else {
	                        _JsPsych2.default.loadFail();
	                    }
	                };
	                request.send();
	            }
	            ...
	            for (var i = 0; i < files.length; i++) {
	                var _bufferID = files[i];
	                if (typeof this.audio_buffers[_bufferID] !== 'undefined') {
	                    n_loaded++;
	                    loadfn(n_loaded);
	                    if (n_loaded === files.length) {
	                        finishfn();
	                    ...
	                    this.audio_buffers[_bufferID] = 'tmp';
	                    if (module.audioContext() !== null) {
	                        load_audio_file_webaudio(_bufferID);
	                    } else {
	                        load_audio_file_html5audio(_bufferID);
	                    }
	                }
	            }
	        }
	        ...
	        key: 'preloadImages',
	        value: function preloadImages(images, callback_complete, callback_load) {

	            // flatten the images array
	            images = _JsPsych2.default.utils.flatten(images);
	            images = _JsPsych2.default.utils.unique(images);
	        ...
	        key: 'registerPreload',
	        value: function registerPreload(plugin_name, parameter, media_type, conditional_function) {
	        ...
	        key: 'autoPreload',
	        value: function autoPreload(timeline, callback, images, audio, progress_bar) {
	            ...
	            for (var i = 0; i < this.preloads.length; i++) {
	                ...
	                var func = this.preloads[i].conditional_function;
	            ...
	            images = (0, _utility.unique)(images);
	            audio = (0, _utility.unique)(audio);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.deepCopy = exports.unique = exports.flatten = exports.compareKeys = undefined;
	...
	var compareKeys = exports.compareKeys = function compareKeys(key1, key2) {
	...
	var flatten = exports.flatten = function flatten(arr, out) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Data = function () {
	    function Data() {
	        ...
	        this.allData = DataCollection();
	        this.interactionData = DataCollection();
	        this.dataProperties = {};
	        this.query_string = undefined;
	    }
	    ...
	    _createClass(Data, [{
	        ...
	        key: 'displayData',
	        value: function displayData(format) {
	        ...
	        key: 'saveTextToFile',
	        value: function saveTextToFile(textstr, filename) {
	        ...
	        key: 'JSON2CSV',
	        value: function JSON2CSV(objArray) {
	...
	function initTurk(jsPsych) {
	    jsPsych.prototype.turk = function () {
	        ...
	        module.submitToTurk = function (data) {
	            ...
	            var turkInfo = _JsPsych2.default.turk.turkInfo();
